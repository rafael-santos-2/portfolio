...
export type TAvatarGroupExtendVariant = {
  compact: true;
};
...
type TPaletteColor = (typeof COLORS)[number] | 'default';

const colorByName = (name?: string): TPaletteColor => {
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars -- avatar color variant scaffolding, enable via commented variants array below
