...
export type TPaginationExtendVariant = {
  soft: true;
};

export type TPaginationExtendColor = {
  info: true;
  success: true;
  warning: true;
  error: true;
    ...
    style: ({ theme }) => ({
      [`& .${paginationItemClasses.root}`]: {
        [`&.${paginationItemClasses.selected}`]: {
          ...
          '&:hover': { backgroundColor: varAlpha(theme.palette[color].mainChannel, 0.16) },
      ...
      style: ({ theme }) => ({
        [`& .${paginationItemClasses.root}`]: {
          [`&.${paginationItemClasses.selected}`]: {
            ...
            '&:hover': { backgroundColor: varAlpha(theme.palette.grey['500Channel'], 0.16) },
          },
        },
      }),
    },
