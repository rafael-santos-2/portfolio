...
const AlertInfoIcon = (props: SvgIconProps): JSX.Element => (
  <SvgIcon {...props}>
    <path
      fill="currentColor"
      fillRule="evenodd"
...
const AlertSuccessIcon = (props: SvgIconProps): JSX.Element => (
  <SvgIcon {...props}>
    <path
      fill="currentColor"
      fillRule="evenodd"
...
const AlertWarningIcon = (props: SvgIconProps): JSX.Element => (
  <SvgIcon {...props}>
    <path
      fill="currentColor"
      fillRule="evenodd"
...
const AlertErrorIcon = (props: SvgIconProps): JSX.Element => (
  <SvgIcon {...props}>
    <path
      fill="currentColor"
      fillRule="evenodd"
...
function style_colors(ownerState: AlertProps, styles: (val: TPaletteColor) => CSSObject): CSSObject {
    ...
    outlined: ({ ownerState, theme }) => {
      const styled = {
        colors: style_colors(ownerState, (color) => ({
          ...
          color: theme.vars.palette[color].dark,
          border: `solid 1px ${varAlpha(theme.palette[color].mainChannel, 0.16)}`,
          ...theme.applyStyles('dark', {
            color: theme.vars.palette[color].light,
          }),
