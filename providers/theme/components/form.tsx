  ...
  styleOverrides: {
    root: ({ theme }) => ({
      ...
      [`&.${inputLabelClasses.shrink}`]: {
        ...
        [`&.${inputLabelClasses.focused}`]: { color: theme.vars?.palette.text.primary || theme.palette.text.primary },
        [`&.${inputLabelClasses.error}`]: { color: theme.vars?.palette.error.main || theme.palette.error.main },
        [`&.${inputLabelClasses.disabled}`]: { color: theme.vars?.palette.text.disabled || theme.palette.text.disabled },
