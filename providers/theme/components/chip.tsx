...
export type TChipExtendVariant = {
  soft: true;
};
 ...
 */
const ChipDeleteIcon = (props: SvgIconProps): JSX.Element => (
  <SvgIcon {...props}>
    <path
      fill="currentColor"
      fillRule="evenodd"
...
function style_colors(ownerState: ChipProps, styles: (val: TPaletteColor) => CSSObject): CSSObject {
  ...
  inheritColor: [
    {
      ...
      style: ({ theme }) => ({
        ...
        '&:hover': { backgroundColor: varAlpha(theme.palette.grey['500Channel'], 0.32) },
      }),
    },
  ],
};
