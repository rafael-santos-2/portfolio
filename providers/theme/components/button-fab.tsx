...
// eslint-disable-next-line @typescript-eslint/no-unused-vars -- fab filled variant scaffolding, enable via commented variants array below
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars -- fab outlined variant scaffolding, enable via commented variants array below
const outlinedVariant: Record<string, ComponentsVariants<Theme>['MuiFab']> = {
  colors: COLORS.map((color) => ({
    ...
    style: ({ theme }) => ({
      ...
      border: `solid 1px ${varAlpha(theme.palette[color].mainChannel, 0.48)}`,
      '&:hover': { backgroundColor: varAlpha(theme.palette[color].mainChannel, 0.08) },
    }),
  })),
  base: [
    {
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars -- fab soft variant scaffolding, enable via commented variants array below
  ...
  base: [
    {
      ...
      style: ({ theme }) => ({
        ...
        [`&.${fabClasses.colorInherit}`]: {
          ...
          '&:hover': { backgroundColor: varAlpha(theme.palette.grey['500Channel'], 0.24) },
        },
      }),
    },
  ],
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars -- fab sizes scaffolding, enable via commented variants array below
