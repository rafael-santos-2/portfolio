...
function create_shadows(colorChannel: string): Shadows {
...
export const shadows: Record<TThemeColorScheme, Shadows> = {
  light: create_shadows(grey['500Channel']),
  dark: create_shadows(common.blackChannel),
};
