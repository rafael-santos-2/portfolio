...
import type { PaletteColorChannel, PaletteColor } from '@mui/material/styles';
...
export type TPaletteColorKey = 'primary' | 'secondary' | 'info' | 'success' | 'warning' | 'error';

// Palette color without additional channels
export type TPaletteColorNoPaletteColorChannel = Omit<PaletteColor, 'lighterChannel' | 'darkerChannel'>;

// Palette color with additional channels
export type TPaletteColorWithPaletteColorChannel = PaletteColor & PaletteColorChannel;

// Extended common colors
export type TCommonColorsExtend = {
  whiteChannel: string;
  blackChannel: string;
};

// Extended text colors
export type TTypeTextExtend = {
  disabledChannel: string;
};

// Extended background colors
export type TTypeBackgroundExtend = {
  neutral: string;
  neutralChannel: string;
};

// Extended palette colors
export type TPaletteColorExtend = {
  lighter: string;
  darker: string;
...
export const palette: Record<TThemeColorScheme, ColorSystemOptions['palette']> = {
  light: {
    ...basePalette,
    text: text.light,
