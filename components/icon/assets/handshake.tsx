...
export default function IconHandshake({ color="inherit", size=20 }: IIconAsset) {
  ...
  return (
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size} color={color} fill="none">
            ...
            <path d="M22 14.75H19.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path>
            <path d="M8.5 6.75003L2 6.75003" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path>
    </svg>
