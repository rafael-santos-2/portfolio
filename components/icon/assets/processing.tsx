...
export default function IconProcessing({ color="inherit", size=20 }: IIconAsset) {
  ...
  return (
    ...
    <path d="M17.5001 17.5L22.0001 22" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"></path>
