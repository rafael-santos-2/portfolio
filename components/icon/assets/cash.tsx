...
export default function IconCash({ color="inherit", size=20 }: IIconAsset) {
  ...
  return (
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size} color={color} fill="none">
      <path d="M14.4998 10.4999C14.4998 11.8806 13.3805 12.9999 11.9998 12.9999C10.6191 12.9999 9.4998 11.8806 9.4998 10.4999C9.4998 9.11921 10.6191 7.99992 11.9998 7.99992C13.3805 7.99992 14.4998 9.11921 14.4998 10.4999Z" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"></path>
      ...
      <path d="M19 19.7329C18.1717 19.5965 17.1718 19.5 16.0005 19.5C11.7061 19.5 10.3624 21.1598 5 20.2027" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"></path>
