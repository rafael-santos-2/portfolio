...
export default function IconFlag({ color="inherit", size=20, filled=false }: IIconAsset) {
  ...
  return (
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size} color={color} fill={filled ? "currentColor" : "none"}>
