...
export default function IconContact({ color="inherit", size=20 }: IIconAsset) {
  ...
  return (
    ...
    <path d="M5 6L2.5 6M5 12L2.5 12M5 18H2.5" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"></path>
