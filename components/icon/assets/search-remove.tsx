...
export function IconSearchRemove({ color="inherit", size=20, className }: IIconAsset) {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size} color={color} fill="none" className={className}>
      ...
      <path d="M8 8L11 11M11 11L14 14M11 11L14 8M11 11L8 14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
