...
type TSvgProps = SvgIconProps & { hideBackground?: boolean };

const UploadIllustration = forwardRef<SVGSVGElement, TSvgProps>((props, ref) => {
      ...
      sx={[
        {
          ...
          '--primary-darker': theme.vars.palette.primary.dark,
          width: 320,
          maxWidth: 1,
          flexShrink: 0,
          height: 'auto',
