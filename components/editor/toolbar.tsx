...
import { Link_block } from './components/link-block';
import { Image_block } from './components/image-block';
import { Toolbar_item } from './components/toolbar-item';
import { Heading_block } from './components/heading-block';
...
export function Toolbar({
  ...
  onToggleFullScreen,
  ...other
}: StackProps & TEditorToolbarProps): JSX.Element | null {
  ...
  const group: SxProps<Theme> = { gap: 0.5, display: 'flex' };
    ...
    >
      ...
      <Box sx={group}>
        ...
        <Toolbar_item
          ...
          icon={<path d="M8 3V12C8 14.2091 9.79086 16 12 16C14.2091 16 16 14.2091 16 12V3H18V12C18 15.3137 15.3137 18 12 18C8.68629 18 6 15.3137 6 12V3H8ZM4 20H20V22H4V20Z" />}
        />
        <Toolbar_item
      ...
      <Box sx={group}>
        ...
        <Toolbar_item
          ...
          icon={<path d="M8 4H21V6H8V4ZM5 3V6H6V7H3V6H4V4H3V3H5ZM3 14V11.5H5V11H3V10H6V12.5H4V13H6V14H3ZM5 19.5H3V18.5H5V18H3V17H6V21H3V20H5V19.5ZM8 11H21V13H8V11ZM8 18H21V20H8V18Z" />}
        />
      </Box>
      ...
      {fullItem && (
        <Box sx={group}>
          <Toolbar_item
            ...
            icon={<path d="M16.95 8.46448L18.3642 7.05026L23.3139 12L18.3642 16.9498L16.95 15.5355L20.4855 12L16.95 8.46448ZM7.05048 8.46448L3.51495 12L7.05048 15.5355L5.63627 16.9498L0.686523 12L5.63627 7.05026L7.05048 8.46448Z" />}
          />
          <Toolbar_item
      ...
      {/* Link & Image */}
      <Box sx={group}>
        <Link_block editor={editor} />
        <Image_block editor={editor} />
      </Box>

      {/* Hard break & Clear */}
      <Box sx={group}>
        <Toolbar_item
          aria-label={t('editor.toolbar.hardBreak')}
          className={editorClasses.toolbar.hardbreak}
          onClick={() => editor.chain().focus().setHardBreak().run()}
          icon={<path d="M15 18H16.5C17.8807 18 19 16.8807 19 15.5C19 14.1193 17.8807 13 16.5 13H3V11H16.5C18.9853 11 21 13.0147 21 15.5C21 17.9853 18.9853 20 16.5 20H15V22L11 19L15 16V18ZM3 4H21V6H3V4ZM9 18V20H3V18H9Z" />}
        />
        <Toolbar_item
          aria-label={t('editor.toolbar.clearFormatting')}
          className={editorClasses.toolbar.clear}
          onClick={() => editor.chain().focus().clearNodes().unsetAllMarks().run()}
          icon={<path d="M12.6512 14.0654L11.6047 20H9.57389L10.9247 12.339L3.51465 4.92892L4.92886 3.51471L20.4852 19.0711L19.071 20.4853L12.6512 14.0654ZM11.7727 7.53009L12.0425 5.99999H10.2426L8.24257 3.99999H19.9999V5.99999H14.0733L13.4991 9.25652L11.7727 7.53009Z" />}
        />
      </Box>
      ...
      {fullItem && (
        <Box sx={group}>
          <Toolbar_item
            ...
            icon={<path d="M8 7V11L2 6L8 1V5H13C17.4183 5 21 8.58172 21 13C21 17.4183 17.4183 21 13 21H4V19H13C16.3137 19 19 16.3137 19 13C19 9.68629 16.3137 7 13 7H8Z" />}
          />
          <Toolbar_item
            ...
            icon={<path d="M16 7H11C7.68629 7 5 9.68629 5 13C5 16.3137 7.68629 19 11 19H20V21H11C6.58172 21 3 17.4183 3 13C3 8.58172 6.58172 5 11 5H16V1L22 6L16 11V7Z" />}
          />
        </Box>
      )}
      ...
      <Box sx={group}>
        <Toolbar_item
          aria-label={t('editor.toolbar.fullscreen')}
          active={fullScreen}
