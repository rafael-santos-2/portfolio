...
export function Link_block({ editor }: Pick<TEditorToolbarProps, 'editor'>): JSX.Element | null {
  ...
  return (
    <>
      ...
      <Toolbar_item
        aria-label={t('editor.toolbar.unsetLink')}
      ...
      >
        <Typography variant="subtitle2" sx={{ mb: 1 }}>URL</Typography>
        ...
        <Box sx={{ gap: 1, display: 'flex', alignItems: 'center' }}>
          <TextField
            ...
            sx={{ width: 240 }}
          />
          <Button variant="contained" onClick={handleUpdateUrl}>{t('editor.link.apply')}</Button>
        </Box>
      </Popover>
    </>
  );
